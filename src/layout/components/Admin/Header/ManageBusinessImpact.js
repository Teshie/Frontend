...
const ManageBusinessImpact = () => {
  ...
  const submit = (e) => {
    http
      .post(
        'https://cyberminds-backend.herokuapp.com/api/business_process/business-process',
        {
          name: industry,
        }
      )
    ...
    <div>
      ...
      <Modal show={showHide} className="mt-64">
        <Modal.Header closeButton onClick={() => handleModalShowHide()}>
          <Modal.Title>Add new Business Process</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default ManageBusinessImpact;
