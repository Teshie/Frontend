...
import './Modal.css';
const SuperAdminViewBusinessImpact = () => {
  ...
  useEffect(() => {
    ...
    http
      .get(
        'http://127.0.0.1:8000/api/business_process/get-business-impact-by-superuser/1/3'
      )
      .then((response) => {
...
export default SuperAdminViewBusinessImpact;
